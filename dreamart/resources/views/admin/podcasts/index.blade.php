@extends('admin.layouts.app', ['page' => __('Podcasts'), 'pageSlug' => 'podcasts'])
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-8 text-right">
                            <a href="/admin/podcasts/add" class="btn btn-sm btn-primary">Inserir</a>
                            ...
                            <thead class=" text-primary">
                                <tr>
                                    <th scope="col" class="sortable" data-column="title" data-order="{{ ($column=='title' && $order == 'asc')?'desc':'asc' }}">
                                        Título
                                        <i class="arrow {{ ($column=='title' && $order == 'asc')?'down':'up' }}"></i>
                                    </th>
                                </tr>
                            </thead>
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <a class="dropdown-item" href="/admin/podcasts/edit/{{$row['id']}}">Editar</a>
                                                <a class="dropdown-item deletebutton" href="/admin/podcasts/delete/{{$row['id']}}">Excluir</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
