 @extends('admin.layouts.app', ['page' => __('Criar Podcast'), 'pageSlug' => 'Podcast'])
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="title">{{ __('Adicionar Podcast') }}</h5>
                </div>
                <form method="post" action="/admin/podcasts/store" autocomplete="off" enctype="multipart/form-data">
                    <div class="card-body">
                            @csrf
                            @method('put')
