@extends('admin.layouts.app', ['page' => __('CMS'), 'pageSlug' => 'cms'])
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-8 text-right">
                            <a href="/admin/cms/add" class="btn btn-sm btn-primary">Inserir</a>
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <a class="dropdown-item" href="/admin/cms/edit/{{$row['id']}}">Editar</a>
                                                <a class="dropdown-item deletebutton" href="/admin/cms/delete/{{$row['id']}}">Excluir</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
