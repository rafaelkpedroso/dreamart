 @extends('admin.layouts.app', ['page' => __('Criar Conteúdo'), 'pageSlug' => 'conteudo'])
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="title">{{ __('Adicionar Conteúdo') }}</h5>
                </div>
                <form method="post" action="/admin/cms/store" autocomplete="off">
                    <div class="card-body">
                            @csrf
                            @method('put')
                            ...
                            <div class="form-group{{ $errors->has('text') ? ' has-danger' : '' }}">
                                ...
                                <textarea type="text" name="text" class="form-control{{ $errors->has('text') ? ' is-invalid' : '' }}" placeholder="{{ __('Texto') }}" required value="">
                                </textarea>
                            ...
                            <div class="form-group{{ $errors->has('title_en') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="title_en" class="form-control{{ $errors->has('title_en') ? ' is-invalid' : '' }}" placeholder="{{ __('Título') }}" required value="">
                            ...
                            <div class="form-group{{ $errors->has('text_en') ? ' has-danger' : '' }}">
                                ...
                                <textarea type="text" name="text_en" class="form-control{{ $errors->has('text_en') ? ' is-invalid' : '' }}" placeholder="{{ __('Texto') }}" required value="">
                                </textarea>
