@extends('admin.layouts.app', ['page' => __('Configurações'), 'pageSlug' => 'setups'])
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-8 text-right">
                            <a href="/admin/setups/add" class="btn btn-sm btn-primary">Inserir</a>
                    ...
                    <div class="">
                        <table class="table tablesorter " id="">
                            ...
                            <thead class=" text-primary">
                                <tr>
                                    <th scope="col" class="sortable" data-column="key" data-order="{{ ($column=='key' && $order == 'asc')?'desc':'asc' }}">
                                        Nome
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <a class="dropdown-item" href="/admin/setups/edit/{{$row['id']}}">Editar</a>
                                                <a class="dropdown-item deletebutton" href="/admin/setups/delete/{{$row['id']}}">Excluir</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
