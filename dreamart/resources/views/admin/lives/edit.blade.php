 @extends('admin.layouts.app', ['page' => __('Editar Live'), 'pageSlug' => 'Live'])
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="title">{{ __('Editar Live') }}</h5>
                </div>
                <form method="post" action="/admin/lives/update/{{ $table->id }}" autocomplete="off" enctype="multipart/form-data">
                    <div class="card-body">
                            @csrf
                            @method('put')
