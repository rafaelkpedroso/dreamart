@extends('admin.layouts.app', ['class' => 'login-page', 'page' => __('Login Page'), 'contentClass' => 'login-page'])

@section('content')
    <div class="col-md-10 text-center ml-auto mr-auto">
        <h3 class="mb-5">Área Restrita para a equipe de gestão de Conteúdo da Dream Art</h3>
    </div>
