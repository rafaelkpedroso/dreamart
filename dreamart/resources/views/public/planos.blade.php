...
@section('content')
    ...
    <style>
        ...
        .daform input[type=text], .daform input[type=password], .daform input[type=email]{
    ...
    <div class="container-fluid" style="background-image: url(/img/bgcadastro.png)">
                        ...
                        <div class="steper-content-step step1">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="containercc preload" style="padding-top:42px;">
